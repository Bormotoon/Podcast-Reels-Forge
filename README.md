...
4. **Пересказ эпизода (LLM)**: gemma4 собирает из вычитанного транскрипта читаемую статью — повествование от третьего лица, разделы по смыслу с заголовками, абзацы. Две проверки (объём и лексика относительно источника) не дают модели дописывать своё.
