...
4. **Video Processing**: Cuts clips based on the `moments.json` generated by each model. Each reel also gets its own `reel_XX.md` with a ready-to-post description and 5 hashtags.
